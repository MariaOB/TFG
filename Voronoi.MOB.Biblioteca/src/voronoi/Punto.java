...
public class Punto {
    ...
    // Realizamos las operaciones básicas que se pueden hacer con puntos
    ...
    // Creamos un nuevo punto añadiéndole coordenadas.
    ...
    public static Punto productoMatricial (Punto[] matriz) {
        ...
        if (tam != matriz[0].dimension())
            throw new IllegalArgumentException("No tienen la misma dimensión.");
    ...
    //////// VECTORES DE PUNTOS COMO SÍMPLICES (ENVOLVENTE CONVEXA) ////////////
    ...
    /**
      El resultado es un array de signos, uno para cada vértice, indicando: -1 si el punto está en el mismo lado que 
      el vértice respecto a dicha cara, 0 si el punto está en la cara y +1 si el punto está en el lado contrario. 
     */
    public int[] relacion (Punto[] simplice) {
        ...
        // Calculamos el volumen y vemos qué pasa
    ...
    // Vemos si el punto está fuera del símplice
    ...
    public static Punto circuncentro (Punto[] simplice) {
        ...
        // El centro serían las coordenadas homogéneas
